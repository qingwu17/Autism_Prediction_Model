...
def get_SPxis_case_is_female_header_2D_arr():
    # read SP column header file, columns: sp_id, is_case, is_female
    SP_col_header_file = '/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.deepvariant.rare1pct_variants_het_by_sample_matrix_cleaned.sp_sex_case_43203.txt'
    SP_col_header_lst = []
...
def generate_input_df_SPARK_wes12(GxSP_matrix_file, var2gene_lst_file, var2gene_unconsec_lst_file, VxA_anno_file):
    
    print("in generate_input_df()")

    SPxis_case_is_female_header_matrix = get_SPxis_case_is_female_header_2D_arr() # (43203, 3)
    GxSP_matrix = get_GxSP_2D_arr(GxSP_matrix_file) # (19626, 43203)
    ...
    # add column names to SPxV matrix
    gene_lst_w_unconsecutive_indices_splited, _ = get_gene_lst_of_GxSP(var2gene_lst_file=var2gene_unconsec_lst_file) # 18825
    ...
    # print(new_SPxG_matrix_full) # [43203 rows x 19120 columns]

    # order columns by original gene name list
    gene_lst, VxG_idx_lst = get_gene_lst_of_GxSP(var2gene_lst_file=var2gene_lst_file) # 19117
    ...
    # print(SPxG_matrix_full) # [43203 rows x 19120 columns]
    ...
    print("Shape of input data wo SP_id:", input_df.shape) # (43203, 19119)
...
def main():
    ...
    GxSP_matrix_file_exonic = "/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.deepvariant.rare1pct_variants_het_by_sample_matrix_cleaned_2GxSP.txt"
    var2gene_unconsec_lst_file_exonic ='/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.deepvariant.rare1pct_variants_het.idx_var2gene_lst_df.unconsecutive_indices_splited.txt'
    var2gene_lst_file_exonic ='/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.deepvariant.rare1pct_variants_het.idx_var2gene_lst_df.txt'
    ...
    X, y, VxA_dummy_df, V2G_idx_lst = generate_input_df_SPARK_wes12(GxSP_matrix_file=GxSP_matrix_file_exonic, 
    ...
    # (43203, 19118) 43203 (1469036, 21) 19117
