...
wes1_mt = hl.read_matrix_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.gatk.pass_QC.mt')
print("Shape of wes1: ", wes1_mt.count())
# GATK (4650932, 26851) -> (4276376, 27266)

wes2_mt = hl.read_matrix_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes2_15995_exome.gatk.pass_QC.mt')
...
# # GATK (7266816, 42697) -> (6281625, 43252)
...
# # de novo:  frozendict({'HIGH': 4, 'LOW': 24})
...
#     ).export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.dnvs.tsv')
...
#     ).export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.dnvs_def.tsv')
...
# # Filtering 62.69% entries out of downstream analysis.
...
# # Removed variants with low confidence, 4177391 variants remain.
...
# # Removed variants with MAF >= 0.01, 4089243 variants remain.
...
# # Removed variants with AF >= 0.01 in non-neuro population, 4072222 variants remain.
...
# # Shape of output matrix table: (4072222, 42651)

# export to vcf.bgz
hl.export_vcf(mt_out, '/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.rare1pct_variants_het.vcf.bgz')
...
# # Count of dnvs in rare mt output:  

# export
mt_out_w_dnv.dnv_confidence.export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.rare1pct_variants_het.w_dnv.tsv')
...
# # Removed variants with low confidence,  variants remain.
...
# print('Removed variants with MAF >= 0.01, %d variants remain.' % rare_variant_wi_SPARK.count_rows())
# # Removed variants with MAF >= 0.01,  variants remain.

# rare variants: remove variants with non-neuro gnomAD population AF >= 0.1% 
rare_variants_by_gnomAD = rare_variant_wi_SPARK.filter_rows(rare_variant_wi_SPARK.non_neuro_pop_AF > 0.01, keep=False)
# print('Removed variants with AF >= 0.01 in non-neuro population, %d variants remain.' % rare_variants_by_gnomAD.count_rows())
# # Removed variants with AF >= 0.001 in non-neuro population,  variants remain.

# select genotype to export
mt_out = rare_variants_by_gnomAD.select_cols().select_rows().select_entries('GT')
# print("Shape of output matrix table: ", mt_out.count())
# # Shape of output matrix table: ()

# # export to vcf.bgz
# hl.export_vcf(mt_out, '/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.rare1pct_variants.vcf.bgz')
...
# # export
# mt_out_w_dnv.dnv_confidence.export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.rare1pct_variants.w_dnv.tsv')
...
# frozendict({False: 3114, True: 8546})

combined_mt.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.sample_id.tsv")
trio_mt.proband.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.trio_proband_id.tsv")
trio_mt.father.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.trio_father_id.tsv")
trio_mt.mother.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.trio_mother_id.tsv")

trio_sample_id = hl.import_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.trio_id_flag.tsv').key_by('s')
trio_sample_id.show()
...
combined_mt.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.sample_id.tsv")
combined_mt.pheno.is_female.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.is_female.tsv")
combined_mt.pheno.is_case.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_wes2_combined.gatk.is_case.tsv")
