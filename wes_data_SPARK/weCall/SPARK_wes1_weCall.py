...
hl.import_vcf('/users/qwu24/data/silvio/SPARK_Data_Aug_2021/pub/WES1/Variants/weCall/wes1_27281_exome.wecall.vcf.gz', reference_genome='GRCh38', \
	...
	force_bgz=True, array_elements_required=False).write('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.mt', overwrite=True)
mt = hl.read_matrix_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.mt')
...
# # export sample id
# mt.s.export("/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.sample_id.tsv")
...
# hl.export_vcf(mt_1to5, '/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.individual_1to5.vcf.bgz')

# vep annotated 1to5
# import
hl.import_vcf('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.individual_1to5.vep_anno_segdup.vcf', reference_genome='GRCh38', \
	contig_recoding={'1': 'chr1', '2': 'chr2', '3': 'chr3', '4': 'chr4', '5': 'chr5', '6': 'chr6', '7': 'chr7', '8': 'chr8', '9': 'chr9', '10': 'chr10', \
					'11': 'chr11', '12': 'chr12', '13': 'chr13', '14': 'chr14', '15': 'chr15', '16': 'chr16', '17': 'chr17', '18': 'chr18', '19': 'chr19', '20': 'chr20', \
					'21': 'chr21', '22': 'chr22', 'X': 'chrX', 'Y': 'chrY'}, \
	force_bgz=True, find_replace=('nul', '.'), array_elements_required=False).write('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.individual_1to5.vep_anno_segdup.mt', overwrite=True)
mt_1to5_vep = hl.read_matrix_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.individual_1to5.vep_anno_segdup.mt')
# shape of the matrix table
...
mt_1to5_vep.info.CSQ[0].export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.individual_1to5.CSQ.tsv')
...
vep_anno = hl.import_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.segdup.tsv', impute=True)
...
# # Filtering % entries out of downstream analysis.
...
# # Removed duplicate samples,  samples remain.
...
mt_pass_varQC.write('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.pass_QC.mt', overwrite=True)
...
mt_pass_QC = hl.read_matrix_table('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.pass_QC.mt')
# shape of the matrix table
mt_pass_QC.count()
# 
'''
...
# 	).export('/users/qwu24/data/silvio/Qing_Wu/SFARI/hail_out/SPARK/wes1_27281_exome.wecall.dnvs.tsv')
